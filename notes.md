...
* Limited to medium size, a larger size requires some sharding mechanism; the binding creations and deletions would eventually overwhelm the cluster without sharding.
